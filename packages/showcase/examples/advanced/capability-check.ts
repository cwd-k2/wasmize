import { compile, Type, Mod, Mem } from "wasmize/dsl/compiler";
import { instantiate } from "wasmize/runtime/instantiate";
import { Features, scanFeatures, suggestTarget, describeFeature } from "wasmize/wasm/capabilities";
import { compileToIR } from "wasmize/dsl/interpreter";
