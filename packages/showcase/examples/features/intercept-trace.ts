import { compile, param, locals, local, Type, Mod, Ctrl, withTrace, type TraceEntry } from "wasmize/dsl/compiler";
import { instantiate } from "wasmize/runtime/instantiate";
import { createProfile, withProfiling, type InstructionProfile } from "wasmize/dsl/instrument";
