import { compile, param, Type, Mod, Mem } from "wasmize/dsl/compiler";
import { instantiate } from "wasmize/runtime/instantiate";
import { builtinPasses, withoutPasses, type OptimizerPass } from "wasmize/wasm/optimizer-passes";
import { IR, type IRNode } from "wasmize/wasm/ir";
