import { compile, local, locals, Type, Mod, Ctrl, Op, f64 } from "wasmize/dsl/compiler";
import type { VoidStmt, WasmBinary } from "wasmize/dsl/types";
import { Struct, BumpAllocator } from "wasmize/dsl/primitives";
